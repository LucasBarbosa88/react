...
export default class App extends Component {
  ...
  async componentDidMount() {
    const repos = JSON.parse(await AsyncStorage.getItem('@GitHub:repositories')) || [];
    this.setState({repos});
  }
  ...
  _addRepository = async (newRepoText) => {
    ...
    await AsyncStorage.setItem('@GitHub:repositories', JSON.stringify(this.state.repos));
  };
  ...
  <View style={styles.container}>
     	<View style={styles.header}>
	      <Text style={styles.headerText}>GitHub Repositoris</Text>
